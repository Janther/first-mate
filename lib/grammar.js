(function() {
  var Emitter, EmitterMixin, Grammar, Grim, Injections, OnigRegExp, Pattern, Rule, ScopeSelector, TokenizeLineResult, path, _;
  ...
  module.exports = Grammar = (function() {
    ...
    Grammar.prototype.tokenizeLines = function(text, compatibilityMode) {
      var lastLine, line, lineNumber, lines, ruleStack, scopes, tags, _i, _len, _ref, _results;
      ...
      for (lineNumber = _i = 0, _len = lines.length; _i < _len; lineNumber = ++_i) {
        ...
        _ref = this.tokenizeLine(line, ruleStack, lineNumber === 0, compatibilityMode, lineNumber !== lastLine), tags = _ref.tags, ruleStack = _ref.ruleStack;
    ...
    Grammar.prototype.tokenizeLine = function(inputLine, ruleStack, firstLine, compatibilityMode, appendNewLine) {
      var contentScopeName, initialRuleStackLength, lastRule, lastSymbol, line, match, nextTags, openScopeTags, penultimateRule, popStack, position, previousPosition, previousRuleStackLength, rule, scopeName, string, stringWithNewLine, tag, tagCount, tags, tagsEnd, tagsStart, tokenCount, truncatedLine, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
      if (firstLine == null) {
        firstLine = false;
      }
      if (compatibilityMode == null) {
      ...
      string = line;
      stringWithNewLine = appendNewLine ? line + '\n' : string;
      if (ruleStack != null) {
        ...
        _ref1 = this.initialRule, scopeName = _ref1.scopeName, contentScopeName = _ref1.contentScopeName;
        ruleStack = [
          {
